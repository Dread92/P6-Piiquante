...
const password= process.env.PASSWORD // on passe le password présent dans env pour éviter qu'il soit visible
const username = process.env.USERNAME // on passe également le user name depuis le fichier .env
