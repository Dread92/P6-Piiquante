...
const auth= require('auth'); // on requiert notre auth qui vérifie l'authenticité de nos tokens, puis nous l'appliquons à chaque gestionnaire de route du fichier.
...
router.get('/',auth, sauceController.getAllStuff);
